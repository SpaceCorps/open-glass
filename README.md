...
- **Playground app** — `apps/playground`, a Vite+ single-page app with a control for every optical parameter — including Frosting Saturation and Glass Brightness (1.00 "composite as blurred" to 2.00, stepping by 0.05, defaulting to the calibrated 1.50) — and live-updating numeric readouts, a macOS-style desktop scene and a visionOS-style spatial scene.
